...
function App() {
  ...
  useEffect(() => {
    ...
    const fetchItems = () => {
      fetch('https://bookstore-a1c4a-default-rtdb.europe-west1.firebasedatabase.app/books/.json')
      ...
      const deleteBook = (id) => {
        fetch(`https://bookstore-a1c4a-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`,
        {
          method: 'DELETE',
        })
        .then(response => fetchItems())
